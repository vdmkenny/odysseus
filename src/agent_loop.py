...
PLAN_MODE_DIRECTIVE = (
    ...
    "rejected. To investigate, use the read-only tools: read_file, grep, glob, ls, "
    "web_search/web_fetch, search_chats, and the list_* tools. These let you read "
    "files, search code, and browse the project to ground the plan. If the task is "
    "'write a file', your plan is to DESCRIBE writing it — you do NOT write it now.\n"
    "\n"
